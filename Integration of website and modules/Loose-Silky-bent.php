	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				...
				<hr>
				<h1 class="tm-title bold shadow">We believe it belongs to Loose Silky-bent</h1>
...
<section class="container">
	<div class="row">
		<div class="col-md-6 col-sm-12">
			<div class="about">
				<h3 class="accent">Loose Silky-bent</h3>
				<h2>description</h2>
				<p>is an annual or biannual plant in the genus Apera. It belongs to the Poaceae family.

This species is native to Eurasia and North Africa from the Canary Islands to Denmark to Yakutia.</p>
			</div>
		</div>
		<div class="col-md-6 col-sm-12">
			<div class="skills">
				<h2 class="white">History</h2>
				It occurs in pastures with sandy soil.
	...
	<div class="row">
			...
			<div class="education">
				<h2 class="white">Plant breeding</h2>
					<div class="education-content">
						...
						<p class="education-description">It flowers from August to September. The name derives from the readily falling grain. Dropseed has little value as food; its palatability decreases with its age.
					</div>
			</div>
		</div>
		<div class="col-md-4 col-sm-12">
			<div class="languages">
				<h2>List</h2>
					<ul>
						<li>Apera spica-venti</li>
						<li>common windgrass</li>
		...
		<div class="row">
			<div class="col-md-12 col-sm-12">
				...
				<ul class="social-icons">
                  Descriptions and images come from  https://en.wikipedia.org/wiki/Apera_spica-venti <br>http://adlib.everysite.co.uk/adlib/defra/content.aspx?id=000HK277ZX.0AGZCS09TISKYO
				</ul>
			</div>
		</div>
	</div>
