...
<section class="container">
	<div class="row">
		<div class="col-md-6 col-sm-12">
			<div class="about">
				<h3 class="accent">Common Wheat</h3>
				<h2>description</h2>
				<p>Common wheat (Triticum aestivum), also known as bread wheat, is a cultivated wheat species. About 95% of the wheat produced is common wheat,which is the most widely grown of all crops and the cereal with the highest monetary yield.</p>
			</div>
		</div>
		<div class="col-md-6 col-sm-12">
			<div class="skills">
	...
	<div class="row">
			...
			<div class="education">
				<h2 class="white">Plant breeding</h2>
					<div class="education-content">
						...
						<p class="education-description">Modern wheat varieties have short stems, the result of RHt dwarfing genes that reduce the plant's sensitivity to gibberellic acid, a plant hormone that lengthens cells. RHt genes were introduced to modern wheat varieties in the 1960s by Norman Borlaug from Norin 10 cultivars of wheat grown in Japan. Short stems are important because the application of high levels of chemical fertilizers would otherwise cause the stems to grow too high, resulting in lodging (collapse of the stems). Stem heights are also even, which is important for modern harvesting techniques.</p>
					</div>
			</div>
		</div>
		<div class="col-md-4 col-sm-12">
			<div class="languages">
				<h2>List</h2>
					<ul>
						<li>T. aestivum Bearded spring wheat</li>
						<li>T. hybernum Beardless winter wheat</li>
						<li>T. turgidum Rivet wheat</li>
						<li>T. spelta Spelt wheat</li>
						<li>T. monococcum Einkorn wheat</li>
					</ul>
			</div>
		</div>
	</div>
